...
A sample of data from the 2009 Annual Survey of Manufacturers is included as `ex_asm`. This data was collected and published using the 2007 NAICS classification codes.
